# Contributing to ml-ol-maps-ng

ml-ol-maps-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-ol-maps-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, AngularJS, and ol-Maps.
...
* **ml-ol-maps-ng Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/marklogic/ml-ol-maps-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-ol-maps-ng.git
$ cd ml-ol-maps-ng
$ git remote add upstream git://github.com/marklogic/ml-ol-maps-ng.git
```
...
Go to https://github.com/username/ml-ol-maps-ng and select your feature branch. Click
...
[wiki]: https://github.com/marklogic/ml-ol-maps-ng/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/marklogic/ml-ol-maps-ng/issues
